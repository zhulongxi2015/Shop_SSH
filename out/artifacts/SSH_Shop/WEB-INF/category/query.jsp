                ...
                toolbar: [{
                    ...
                    handler: function(){
                        parent.$("#win").window({ //因为<div>放在了aindex.jsp中，所以这里创建窗口要先调用parent
                            ...
                            width:350,
                            height:150,
                            content:'<iframe src="link_category_save.action" frameborder="0" width="100%" height="100%"/>'
                        });
                    }
                },'-',{
                    iconCls: 'icon-edit',
                    ...
                    handler: function(){
                        ...
                        if(rows.length == 0) {
                            ...
                            parent.$("#win").window({
                                ...
                                width:350,
                                height:250,
                                content:'<iframe src="link_category_update.action" frameborder="0" width="100%" height="100%"/>'
                            });
                            //2.
                        }
                    }
