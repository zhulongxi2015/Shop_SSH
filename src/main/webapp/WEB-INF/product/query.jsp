                ...
                toolbar: [{
                    ...
                    handler: function(){
                        ...
                        parent.$("#win").window({ //因为<div>放在了aindex.jsp中，所以这里创建窗口要先调用parent
                            ...
                            width:350,
                            height:540,
                            content:'<iframe src="link_product_save.action" frameborder="0" width="100%" height="100%"/>'
                        });
                    }
                },'-',{
                    iconCls: 'icon-edit',
                    ...
                    handler: function(){
                        ...
                        if(rows.length == 0) {
                            ...
                            parent.$("#win").window({
                                ...
                                width:350,
                                height:540,
                                content:'<iframe src="link_product_update.action" frameborder="0" width="100%" height="100%"/>'
                            });
                            //2.
                        }
                    }
