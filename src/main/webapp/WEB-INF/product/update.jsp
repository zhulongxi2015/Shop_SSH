...
<form title="更新商品" id="ff" method="post" enctype="multipart/form-data">
    ...
    <div>
        ...
        是:<input type="radio" name="commend" value="1" /> 
        否:<input type="radio" name="commend" value="0" />
    </div>
    <div>
        <label for="open">有效商品:</label>
        上架:<input type="radio" name="open" value="1" />
        下架:<input type="radio" name="open" value="0" />
